...
##A lógica é simples: o Query Profiler diz-te o quê está mal, o monitoring tab diz-te quando acontece, e com isso decides se aumentas o tamanho, 
##adicionas clusters, ou reduces para poupar custos. 
